...
public static byte[] serialize(com.gojava.msg.protobuf.VipChargeInfoReslut message) {
try {
int totalSize = 0;
...
byte[] curMessageData = com.gojava.msg.protobuf.VipInfoSerializer.serialize(message.getVipInfo().get(i));
...
public static void serialize(com.gojava.msg.protobuf.VipChargeInfoReslut message, java.io.OutputStream os) {
try {
if (message.hasVipInfo()) {
for( int i=0;i<message.getVipInfo().size();i++) {
byte[] curMessageData = com.gojava.msg.protobuf.VipInfoSerializer.serialize(message.getVipInfo().get(i));
...
public static com.gojava.msg.protobuf.VipChargeInfoReslut parseFrom(byte[] data) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.VipChargeInfoReslut parseFrom(byte[] data, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.VipChargeInfoReslut parseFrom(byte[] data, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.VipChargeInfoReslut message = new com.gojava.msg.protobuf.VipChargeInfoReslut();
while(true) {
...
message.setVipInfo(new java.util.ArrayList<com.gojava.msg.protobuf.VipInfo>());
}
int lengthVipInfo = ProtobufInputStream.readRawVarint32(data,cursor);
message.getVipInfo().add(com.gojava.msg.protobuf.VipInfoSerializer.parseFrom(data, cursor.getCurrentPosition(), lengthVipInfo));
...
public static com.gojava.msg.protobuf.VipChargeInfoReslut parseFrom(java.io.InputStream is) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.VipChargeInfoReslut parseFrom(java.io.InputStream is, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.VipChargeInfoReslut parseFrom(java.io.InputStream is, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.VipChargeInfoReslut message = new com.gojava.msg.protobuf.VipChargeInfoReslut();
while(true) {
...
message.getVipInfo().add(com.gojava.msg.protobuf.VipInfoSerializer.parseFrom(is, cursor.getCurrentPosition(), lengthVipInfo));
cursor.addToPosition(lengthVipInfo);
break;
case 2: 

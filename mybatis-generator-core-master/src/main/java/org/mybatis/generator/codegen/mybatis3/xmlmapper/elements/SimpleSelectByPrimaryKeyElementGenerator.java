...
public class SimpleSelectByPrimaryKeyElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        sb.setLength(0);
        sb.append("from ");
        if(StringUtility.stringHasValue(context.getJdbcConnectionConfiguration().getDbName())){             sb.append(context.getJdbcConnectionConfiguration().getDbName());             sb.append('.');         } //$NON-NLS-1$

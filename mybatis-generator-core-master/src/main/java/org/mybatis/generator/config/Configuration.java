...
public class Configuration {
    ...
    //IOC”≥…‰
    private String mappconfigdir;
    public String getMappconfigdir() {
		return mappconfigdir;
	}

	public void setMappconfigdir(String mappconfigdir) {
		this.mappconfigdir = mappconfigdir;
	}

	//mapper∫Õmap.xmlµƒ”≥…‰
    private String mybaitmapperdir;
    
    public String getMybaitmapperdir() {
		return mybaitmapperdir;
	}

	public void setMybaitmapperdir(String mybaitmapperdir) {
		this.mybaitmapperdir = mybaitmapperdir;
	}

...
public static byte[] serialize(com.gojava.msg.protobuf.FirstCharge message) {
try {
...
public static void serialize(com.gojava.msg.protobuf.FirstCharge message, java.io.OutputStream os) {
try {
assertInitialized(message);
if (message.hasUserId()) {
...
public static com.gojava.msg.protobuf.FirstCharge parseFrom(byte[] data) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.FirstCharge parseFrom(byte[] data, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.FirstCharge parseFrom(byte[] data, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.FirstCharge message = new com.gojava.msg.protobuf.FirstCharge();
while(true) {
...
public static com.gojava.msg.protobuf.FirstCharge parseFrom(java.io.InputStream is) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.FirstCharge parseFrom(java.io.InputStream is, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.FirstCharge parseFrom(java.io.InputStream is, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.FirstCharge message = new com.gojava.msg.protobuf.FirstCharge();
while(true) {
...
private static void assertInitialized(com.gojava.msg.protobuf.FirstCharge message) {
if( !message.hasUserId()) {

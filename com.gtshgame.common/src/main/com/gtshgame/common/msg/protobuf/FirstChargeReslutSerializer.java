...
public static byte[] serialize(com.gtshgame.common.msg.protobuf.FirstChargeReslut message) {
try {
...
public static void serialize(com.gtshgame.common.msg.protobuf.FirstChargeReslut message, java.io.OutputStream os) {
try {
assertInitialized(message);
if (message.hasState()) {
...
public static com.gtshgame.common.msg.protobuf.FirstChargeReslut parseFrom(byte[] data) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(data, cursor);
}
public static com.gtshgame.common.msg.protobuf.FirstChargeReslut parseFrom(byte[] data, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(data, cursor);
}
public static com.gtshgame.common.msg.protobuf.FirstChargeReslut parseFrom(byte[] data, CurrentCursor cursor) throws java.io.IOException {
com.gtshgame.common.msg.protobuf.FirstChargeReslut message = new com.gtshgame.common.msg.protobuf.FirstChargeReslut();
while(true) {
...
public static com.gtshgame.common.msg.protobuf.FirstChargeReslut parseFrom(java.io.InputStream is) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(is, cursor);
}
public static com.gtshgame.common.msg.protobuf.FirstChargeReslut parseFrom(java.io.InputStream is, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(is, cursor);
}
public static com.gtshgame.common.msg.protobuf.FirstChargeReslut parseFrom(java.io.InputStream is, CurrentCursor cursor) throws java.io.IOException {
com.gtshgame.common.msg.protobuf.FirstChargeReslut message = new com.gtshgame.common.msg.protobuf.FirstChargeReslut();
while(true) {
...
private static void assertInitialized(com.gtshgame.common.msg.protobuf.FirstChargeReslut message) {
if( !message.hasState()) {

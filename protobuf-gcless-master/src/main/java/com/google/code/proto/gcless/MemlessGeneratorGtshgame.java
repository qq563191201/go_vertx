...
public class MemlessGeneratorGtshgame {
	...
	public static void main(String[] args) throws Exception {
		String testConfig="C:\\workspace\\platformServer\\com.gtshgame\\Tools\\AutoConfig.xml";
...
*/
	...
	private static void process(File output, MemlessParser parser,String ProtobufName,JSONObject jsonObj) throws IOException, Exception {
		...
		LogiceTmpCode.append("package com.gtshgame.vertx.bean.logics;\n");
		LogiceTmpCode.append("import %s;\n");
		LogiceTmpCode.append("import %s;\n");
		LogiceTmpCode.append("import com.gtshgame.vertx.bean.interfaces.LogicsInterfaces;\n");
		...
		StringBuilder vertxController=new StringBuilder();
		//-------------------JSON----------
		vertxController.append("package com.gtshgame.vertx.handler; \n");
		...
		vertxController.append("import com.gtshgame.App;\n import io.vertx.core.AbstractVerticle;\n");
		...
		vertxController.append("loger.info(ctx.getBodyAsString());\n");
		...
		vertxController.append("loger.error(\"e\", e);\n");
		vertxController.append("ctx.response().end(\"{\\\"issucc\\\":false}\");}\n}\n");
		vertxController.append("@Override\n");
		...
		vertxController_protobuf.append("package com.gtshgame.vertx.handler; \n");
		...
		vertxController_protobuf.append("import com.gtshgame.App;\n import io.vertx.core.AbstractVerticle;\n");
		...
		vertxController_msgpack1.append("package com.gtshgame.vertx.handler;\n");
		...
		vertxController_msgpack1.append("import com.gtshgame.App;\n import io.vertx.core.AbstractVerticle;\n");
	    ...
	    vertxController_msgpack1.append("loger.error(\"e\", e);\n");
...
//		BeanStr.append("package com.gtshgame.msg.beans;\n");
//
...
//		BeanStr.append("import com.gtshgame.common.interfaces.MsgInterface;\n");
//
...
//		BeanStr.append("}\n");
		...
		beanVertx.append("import org.springframework.context.ApplicationContextAware;\nimport com.gtshgame.common.errors.VerifyFieldValueNotPassException;");
		beanVertx.append("import com.gtshgame.common.interfaces.MsgInterfaceVertx;\n");
		...
		//---------------------------------------------------
		beanController.append("package com.gtshgame.msg.controllers;\n");
		...
		beanController.append("import com.gtshgame.common.interfaces;\n");
	...
	/*	beanPostController.append("@PostMapping(path='/%s/{params}',consumes = 'application/msgpack', produces = MediaType.APPLICATION_JSON_UTF8_VALUE)\n");
		...
		//		BeanControllers.append(beangetstring).append("\n").append(beanpostetstring).append("\n");
				...
				LogicBeanXML.append(String.format(tmpbeam, ProtobufName+"_bean_"+curMessage.getName()+"","com.gtshgame.vertx.bean.logics.Bean_Logic_"+ProtobufName+"_"+curMessage.getName()+""));
				
				BeanSpringGo.append(String.format(tmpbeam, "b_vertx_"+ProtobufName+"_"+curMessage.getName()+"_Json_Handler","com.gtshgame.vertx.handler.vertx_"+ProtobufName+"_"+curMessage.getName()+"_Json_Handler"));
				//-----------vertx-------------------------
				...
				BeanSpringGo.append(String.format(tmpbeam, "b_vertx_"+ProtobufName+"_"+curMessage.getName()+"_MsgPack_Handler","com.gtshgame.vertx.handler.vertx_"+ProtobufName+"_"+curMessage.getName()+"_MsgPack_Handler"));
				...
				//
				BeanSpringGo.append(String.format(tmpbeam, "com.gtshgame.vertx.beans.Bean_Vertx_"+ProtobufName+"_"+curMessage.getName()+"","com.gtshgame.vertx.beans.Bean_Vertx_"+ProtobufName+"_"+curMessage.getName()+""));
	...
	private static void copy(String classpathFileName, File output, String packageName) throws IOException {
		InputStream protobufOutputStream = MemlessGeneratorGtshgame.class.getClassLoader().getResourceAsStream(classpathFileName);

...
public static byte[] serialize(com.gojava.msg.protobuf.VipInfo message) {
try {
int totalSize = 0;
byte[] vipBuffer = null;
if (message.hasVip()) {
...
byte[] curMessageData = com.gojava.msg.protobuf.VipMoneyInfoSerializer.serialize(message.getVipMoneyInfo().get(i));
...
public static void serialize(com.gojava.msg.protobuf.VipInfo message, java.io.OutputStream os) {
try {
if (message.hasVip()) {
...
public static com.gojava.msg.protobuf.VipInfo parseFrom(byte[] data) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.VipInfo parseFrom(byte[] data, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.VipInfo parseFrom(byte[] data, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.VipInfo message = new com.gojava.msg.protobuf.VipInfo();
while(true) {
...
message.setVipMoneyInfo(new java.util.ArrayList<com.gojava.msg.protobuf.VipMoneyInfo>());
}
int lengthVipMoneyInfo = ProtobufInputStream.readRawVarint32(data,cursor);
message.getVipMoneyInfo().add(com.gojava.msg.protobuf.VipMoneyInfoSerializer.parseFrom(data, cursor.getCurrentPosition(), lengthVipMoneyInfo));
cursor.addToPosition(lengthVipMoneyInfo);
break;
}
}
}
public static com.gojava.msg.protobuf.VipInfo parseFrom(java.io.InputStream is) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.VipInfo parseFrom(java.io.InputStream is, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.VipInfo parseFrom(java.io.InputStream is, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.VipInfo message = new com.gojava.msg.protobuf.VipInfo();
while(true) {
...
message.getVipMoneyInfo().add(com.gojava.msg.protobuf.VipMoneyInfoSerializer.parseFrom(is, cursor.getCurrentPosition(), lengthVipMoneyInfo));
cursor.addToPosition(lengthVipMoneyInfo);
break;
}
}

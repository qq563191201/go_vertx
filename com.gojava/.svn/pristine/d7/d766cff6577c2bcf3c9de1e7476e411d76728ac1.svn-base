...
public static byte[] serialize(com.gojava.msg.protobuf.VipMoneyInfo message) {
try {
int totalSize = 0;
byte[] dayBuffer = null;
if (message.hasDay()) {
...
public static void serialize(com.gojava.msg.protobuf.VipMoneyInfo message, java.io.OutputStream os) {
try {
if (message.hasDay()) {
...
public static com.gojava.msg.protobuf.VipMoneyInfo parseFrom(byte[] data) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.VipMoneyInfo parseFrom(byte[] data, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(data, cursor);
}
public static com.gojava.msg.protobuf.VipMoneyInfo parseFrom(byte[] data, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.VipMoneyInfo message = new com.gojava.msg.protobuf.VipMoneyInfo();
while(true) {
...
public static com.gojava.msg.protobuf.VipMoneyInfo parseFrom(java.io.InputStream is) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.VipMoneyInfo parseFrom(java.io.InputStream is, int offset, int length) throws java.io.IOException {
CurrentCursor cursor = new CurrentCursor();
cursor.addToPosition(offset);
cursor.setProcessUpToPosition(offset + length);
return parseFrom(is, cursor);
}
public static com.gojava.msg.protobuf.VipMoneyInfo parseFrom(java.io.InputStream is, CurrentCursor cursor) throws java.io.IOException {
com.gojava.msg.protobuf.VipMoneyInfo message = new com.gojava.msg.protobuf.VipMoneyInfo();
while(true) {

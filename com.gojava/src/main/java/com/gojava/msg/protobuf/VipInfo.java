...
private java.util.List<com.gojava.msg.protobuf.VipMoneyInfo> vipMoneyInfo;
private boolean hasVipMoneyInfo;
public boolean hasVipMoneyInfo() {
return hasVipMoneyInfo;
}
public java.util.List<com.gojava.msg.protobuf.VipMoneyInfo> getVipMoneyInfo() {
return vipMoneyInfo;
}
public void setVipMoneyInfo(java.util.List<com.gojava.msg.protobuf.VipMoneyInfo> VipMoneyInfo) {
...
java.util.Iterator<com.gojava.msg.protobuf.VipMoneyInfo> it;
it=vipMoneyInfo.iterator();
while(it.hasNext()){
m_vipMoneyInfo.add(it.next().toMap());
}
} else {
for (final com.gojava.msg.protobuf.VipMoneyInfo value : vipMoneyInfo) {

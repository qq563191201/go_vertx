...
import com.gtshgame.vertx.GoHttpServer;
...
@ComponentScan(basePackages = "com.gtshgame.msg.controllers,com.gtshgame.vertx,com.gtshgame.component,com.gtshgame.vertx.config")
public class App 
{
	...
	public static void main( String[] args )
    {
    	...
    	context =
    		    new ClassPathXmlApplicationContext(new String[] {"applicationContext.xml","autobean.xml","bean_logic.xml"});
